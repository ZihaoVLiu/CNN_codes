...
if __name__ == '__main__':
    ...
    model = Liu_ShiNet50(input_shape=(480, 480, 1), classes=3)
    ...
    lists_data = load_covidx(h5_train, 4)
    ...
    generator_train, generator_valid, step_per_epoch, validation_steps = \
        get_fold_valid(lists_data, batch_size=batch_size)
    ...
    lists_test = load_covidx(h5_train, 2)
    print("Number of test examples = " + str(len(lists_test[0])))
    generator_test, steps = get_test_data(lists_test, batch_size)
